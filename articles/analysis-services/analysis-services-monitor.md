...
ms.openlocfilehash: e0d730a6cfba3aa1da47b0ab8c156d049e71091a
ms.sourcegitcommit: e435672bdc9400ab51297134574802e9a851c60e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/04/2021
ms.locfileid: "102053324"
---
...
1. 在 Azure 门户中，选择“指标”  。
    ...
    :::image type="content" source="./media/analysis-services-monitor/aas-monitor-portal.png" alt-text="在 Azure 门户中监视":::

2. 在 **指标** 中，选择要在图表中包括的指标。 

    :::image type="content" source="./media/analysis-services-monitor/aas-monitor-chart.png" alt-text="监视图表":::
...
|QueryPoolBusyThreads|查询池忙线程数|计数|平均值|查询线程池中的繁忙线程数。|
