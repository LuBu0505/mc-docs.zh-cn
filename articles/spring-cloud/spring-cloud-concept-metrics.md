...
ms.openlocfilehash: 2e2bd2758f44c8ff0aa5b3a62537743e6e15ff46
ms.sourcegitcommit: 3f32b8672146cb08fdd94bf6af015cb08c80c390
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/03/2021
ms.locfileid: "101697494"
---
...
>| AppCpuUsage | 应用 CPU 使用情况（预览版） | 百分比 | 针对分配给此应用的 CPU 的 JVM 进程的最近 CPU 使用率，在此值为 [0.0,1.0] 区间中的双精度类型值。 如果值为 0.0，则表示在所观察的最近一段时间内，任何 CPU 都未运行 JVM 进程中的线程，而如果值为 1.0，则表示在所观察的最近一段时间内，所有 CPU 都一直在主动运行 JVM 中的线程。 JVM 中的线程包括应用程序线程以及 JVM 内部线程。|
