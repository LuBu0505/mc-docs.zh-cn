...
2. 所有启动任务均根据其 **taskType** 属性执行。
   ...
   * **background** 和 **foreground** 任务与启动任务并行，以异步方式启动。  
     ...
     > [!WARNING]
     > 在启动过程中的启动任务阶段，IIS 可能未完全配置，因此角色特定的数据可能不可用。 需要角色特定数据的启动任务应使用 [Microsoft.WindowsAzure.ServiceRuntime.RoleEntryPoint.OnStart](https://docs.microsoft.com/previous-versions/azure/reference/ee772851(v=azure.100))。
     > 
     > 
...
[启动]: https://docs.microsoft.com/previous-versions/azure/reference/gg557552(v=azure.100)#Startup
[executionContext]: https://docs.microsoft.com/previous-versions/azure/reference/gg557552(v=azure.100)#Runtime
[ServiceDefinition.csdef]: https://docs.microsoft.com/previous-versions/azure/reference/gg557552(v=azure.100)#Environment
