...
ms.author: v-yeche
ms.openlocfilehash: dc96a1c30a729313688ff711b05c0e04e314cfb4
ms.sourcegitcommit: fb2fba1c106406553ed84b8652a915c823d9ab07
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/11/2021
ms.locfileid: "102996645"
---
...
Azure Cosmos DB 是一种多模型数据库服务，可让你通过多区域分布和水平缩放功能快速创建和查询文档、表、键/值和图数据库。 本文中展示的示例是一个简单的基于命令行的应用程序，它使用 [MongoDB Rust 驱动程序](https://github.com/mongodb/mongo-rust-driver)。 由于 Azure Cosmos DB MongoDB API [与 MongoDB Wire Protocol 兼容](./mongodb-introduction.md#wire-protocol-compatibility)，因此任何 MongoDB 客户端驱动程序都可以与其连接。
...
```bash
export MONGODB_URL="mongodb://<COSMOSDB_ACCOUNT_NAME>:<COSMOSDB_PASSWORD>@<COSMOSDB_ACCOUNT_NAME>.mongo.cosmos.azure.cn:10255/?ssl=true&replicaSet=globaldb&maxIdleTimeMS=120000&appName=@<COSMOSDB_ACCOUNT_NAME>@"
```
