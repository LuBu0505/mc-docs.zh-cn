...
author: rockboyfor
ms.author: v-yeche
ms.openlocfilehash: 84edd29525faf89782313641d3cb29e3854dff7b
ms.sourcegitcommit: fb2fba1c106406553ed84b8652a915c823d9ab07
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/11/2021
ms.locfileid: "102996562"
---
...
Azure Cosmos DB 支持基于文档时间戳的生存时间 (TTL)。 可在 [Azure 门户](https://portal.azure.cn)中为集合启用 TTL。

## <a name="user-and-role-management"></a>用户和角色管理

Azure Cosmos DB 尚不支持用户和角色。 不过，它支持 Azure 基于角色的访问控制 (Azure RBAC) 以及读写和只读密码/密钥，可通过 [Azure 门户](https://portal.azure.cn)中的连接字符串窗格获取这些内容。
