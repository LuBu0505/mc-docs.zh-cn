...
<!--MOONCAKE CUSTOMIZE ON 02/26/2021-->
...
<!--NOT AVAILABLE ON  Azure support is not available with **Basic** plan-->
...
<!--NOT AVAILABLE ON The following screenshot illustrates how to create a support request for a container(collection/graph/table) to restore data by using Azure portal. Provide other details such as type of data, purpose of the restore, time when the data was deleted to help us prioritize the request.-->
<!--NOT AVAILABLE ON :::image type="content" source="./media/configure-periodic-backup-restore/backup-support-request-portal.png" alt-text="Create a backup support request using Azure portal." border="true":::-->
...
<!--NOT AVAILABLE ON continuous-backup feature on Cosmos DB-->
<!--Update_Description: new article about configure periodic backup restore-->
<!--NEW.date: 03/01/2021-->