...
ms.openlocfilehash: 9ecd7136c6f3acd795b105b37975285a82d694e5
ms.sourcegitcommit: 8b3a588ef0949efc5b0cfb5285c8191ce5b05651
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2021
ms.locfileid: "104766157"
---
...
应用程序通过身份验证后，你可以使用 [setSecret 方法](https://docs.microsoft.com/javascript/api/@azure/keyvault-secrets/secretclient#setSecret_string__string__SetSecretOptions_)将机密放入密钥保管库。此操作需要使用机密的名称，本示例中使用“mySecret”。  
...
现在，你可以使用 [getSecret 方法](https://docs.microsoft.com/javascript/api/@azure/keyvault-secrets/secretclient#getSecret_string__GetSecretOptions_)检索以前设置的值。
