...
ms.date: 03/22/2021
ms.openlocfilehash: 8535f1bf1978d24f6c1a60c9ac79c702a1395a22
ms.sourcegitcommit: bed93097171aab01e1b61eb8e1cec8adf9394873
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/26/2021
ms.locfileid: "105602628"
---
...
* .NET Core 在[版本 3.1](https:docs.microsoft.com/dotnet/core/compatibility/3.1) 和[版本 3.0](https:docs.microsoft.com/dotnet/core/compatibility/3.0) 中引入的中断性变更并非特定于 Functions，但可能仍会影响你的应用。
