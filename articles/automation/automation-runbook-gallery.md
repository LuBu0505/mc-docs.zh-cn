...
ms.date: 02/22/2021
ms.topic: conceptual
ms.openlocfilehash: 96b9a3eab0efd9dfed6af9f263a56d0206358103
ms.sourcegitcommit: 3f32b8672146cb08fdd94bf6af015cb08c80c390
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/03/2021
ms.locfileid: "101751786"
---
...
[PowerShell 库](https://www.powershellgallery.com/packages)提供来自 Microsoft 和社区的各种 Runbook，可将其导入 Azure 自动化。 若要使用某种 Runbook，可以从库下载一个 Runbook，也可以直接从 Azure 门户中的自动化帐户导入 Runbook。
...
5. 单击“查看源项目”，以查看 [Azure 自动化 GitHub 组织](https://github.com/azureautomation)中的项。
...
Microsoft 建议将 Runbook 添加到你认为对其他客户有用的 PowerShell 库中。 PowerShell 库接受 PowerShell 模块和 PowerShell 脚本。 可以通过[将 Runbook 上传到 PowerShell 库](https://docs.microsoft.com/powershell/scripting/gallery/how-to/publishing-packages/publishing-a-package)来添加 Runbook。
...
> [!NOTE]
> 仅支持 PowerShell 核心的模块在 Azure 自动化中不受支持，并且无法在 Azure 门户中导入。
