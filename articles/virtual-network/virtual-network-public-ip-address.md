...
ms.author: v-yeche
ms.openlocfilehash: c53f92c7ab85e9fa186d6ab6667db94739dce4bf
ms.sourcegitcommit: e435672bdc9400ab51297134574802e9a851c60e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/04/2021
ms.locfileid: "102053757"
---
...
- [公共负载均衡器](../load-balancer/quickstart-load-balancer-standard-public-portal.md?toc=%2fvirtual-network%2ftoc.json)
- [应用程序网关](../application-gateway/quick-create-portal.md?toc=%2fvirtual-network%2ftoc.json)
- [使用 VPN 网关的站点到站点连接](../vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal.md?toc=%2fvirtual-network%2ftoc.json)
- [虚拟机规模集](../virtual-machine-scale-sets/quick-create-portal.md?toc=%2fvirtual-network%2ftoc.json)
