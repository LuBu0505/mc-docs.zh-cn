...
ms.openlocfilehash: c6a5954aa2d66661fae5acde63878ee03ac718b2
ms.sourcegitcommit: ef5fa52ac5e0e3881f72bd8b56fc73e49444ccc2
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/04/2021
ms.locfileid: "99540649"
---
...
- 当需要用户交互的身份验证流发生任何中断时，ROPC 不起作用。 例如，当密码已过期或需要更改时、当需要[多重身份验证](custom-policy-multi-factor-authentication.md)时，或者在登录期间需要收集更多信息（例如，用户同意）时。
- ROPC 仅支持本地帐户。 用户无法通过[联合标识提供者](add-identity-provider.md)登录。
