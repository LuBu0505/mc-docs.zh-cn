...
ms.openlocfilehash: 6c0440db52b0d96acae5d482cedb03aa200bda11
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102197218"
---
...
[Azure 专用主机](/virtual-machines/dedicated-hosts) | 支持
...
已启用写入加速器的磁盘 | 不支持。<br/><br/> Azure 备份服务将会备份其中磁盘在备份期间启用了加速写入 (WA) 的虚拟机。 <br><br>对于不支持的区域，需在 VM 上建立 Internet 连接才能创建启用了 WA 的虚拟机的快照。<br><br> **重要说明**：在这些不支持的区域中，包含 WA 磁盘的虚拟机需要建立 Internet 连接才能成功进行备份（即使已从备份中排除这些磁盘）。
...
[临时磁盘](/virtual-machines/managed-disks-overview#temporary-disk) | Azure 备份服务不会备份临时磁盘。
