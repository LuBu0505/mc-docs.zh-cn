...
ms.topic: tutorial
ms.author: v-yeche
ms.openlocfilehash: 124e3248733c3db05c89add79c76b135c89d36ae
ms.sourcegitcommit: 1107b0d16ac8b1ad66365d504c925735eb079d93
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99063618"
---
<!--Verified successfully-->
<!--Available on Microsoft.Resources.deploymentScripts-->
...
<!--Not Available on [Extend ARM templates by using deployment scripts](https://docs.microsoft.com/learn/modules/extend-resource-manager-template-deployment-scripts/)-->
...
1. 添加 `deploymentScripts` 资源：
    ...
    > [!NOTE]
    > 由于内联部署脚本是用双引号括起来的，因此部署脚本内的字符串需要改用单引号括起来。 [PowerShell 转义字符](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_quoting_rules#single-and-double-quoted-strings)是反引号 (`` ` ``)。
...
1. 使用管理员权限打开 Powrershell 控制台，并运行以下 PowerShell 脚本以部署模板。
