...
ms.author: v-yeche
ms.custom: ''
ms.openlocfilehash: afeee0bb268a0530927f66c9fad28374ff4fce25
ms.sourcegitcommit: 8b3a588ef0949efc5b0cfb5285c8191ce5b05651
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2021
ms.locfileid: "104768408"
---
...
[Azure 快速入门模板](https://github.com/Azure/azure-quickstart-templates/)是一个存储库，其中包含社区贡献的 JSON 模板。 可以在 Bicep 开发中使用示例模板。 在本教程中，你将查找网站资源定义，将其反向编译为 Bicep，然后将其添加到 Bicep 文件。 完成该过程需要大约 **12 分钟**。
...
<!--CUSOTMIZE ON 03/15/2021-->
<!--CORRECT ON https://azure.microsoft.com/resources/templates/-->
...
1. 查看 Bicep 模板。 具体说来，请查找 `Microsoft.Web/sites` 资源。
    ...
    :::image type="content" source="./media/bicep-tutorial-quickstart-template/resource-manager-template-quickstart-template-web-site.png" alt-text="资源管理器模板快速入门网站":::
...
<!--Update_Description: new article about bicep tutorial quickstart template-->
<!--NEW.date: 03/22/2021-->