...
ms.topic: tutorial
ms.author: v-yeche
ms.openlocfilehash: 1b4ef7a4630a15cb94be5ad4c75c583e2060c37a
ms.sourcegitcommit: 8b3a588ef0949efc5b0cfb5285c8191ce5b05651
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2021
ms.locfileid: "104768428"
---
...
1. 此外还会在历史记录中列出多个成功的部署。 选择该链接。
    ...
    :::image type="content" source="./media/bicep-tutorial-add-outputs/select-deployments.png" alt-text="选择部署":::

1. 可以在历史记录中看到所有部署。 选择名为 **addoutputs** 的部署。

    :::image type="content" source="./media/bicep-tutorial-add-outputs/show-history.png" alt-text="显示部署历史记录":::

1. 可以查看输入。

    :::image type="content" source="./media/bicep-tutorial-add-outputs/show-inputs.png" alt-text="显示输入":::

1. 可以查看输出。

    :::image type="content" source="./media/bicep-tutorial-add-outputs/show-outputs.png" alt-text="显示输出":::

1. 可以查看 JSON 模板。

    :::image type="content" source="./media/bicep-tutorial-add-outputs/show-template.png" alt-text="显示模板":::
...
<!--Update_Description: new article about bicep tutorial add outputs-->
<!--NEW.date: 03/22/2021-->