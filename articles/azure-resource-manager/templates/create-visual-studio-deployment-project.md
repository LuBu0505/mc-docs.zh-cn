...
ms.date: 02/01/2021
ms.author: v-yeche
ms.openlocfilehash: c5a8ddce8c678ce1dee7d727b403f76d6c1a2db9
ms.sourcegitcommit: 1107b0d16ac8b1ad66365d504c925735eb079d93
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99063651"
---
...
本文介绍如何使用[装有 Azure 开发和 ASP.NET 工作负荷的 Visual Studio 2019 或更高版本](https://docs.microsoft.com/visualstudio/install/install-visual-studio)。 如果使用 Visual Studio 2017，体验将大体相同。
...
1. 为你的项目命名。 其他默认设置可能没问题，但请查看它们，使它们适用于你的环境。 完成后，选择“创建”。 
    ...
    :::image type="content" source="./media/create-visual-studio-deployment-project/name-project.png" alt-text="创建项目":::

1. 选择要部署到 Azure 资源管理器的模板。 可以看到，系统根据要部署的项目类型提供了许多不同的选项。 就本文来说，请选择“Web 应用”模板和“确定”   。

    :::image type="content" source="./media/create-visual-studio-deployment-project/select-project.png" alt-text="选择模板":::

    选择的模板只是起点；可以根据方案添加和删除资源。

1. Visual Studio 将创建 Web 应用的资源组部署项目。 若要查看项目文件，请查看部署项目中的节点。

    :::image type="content" source="./media/create-visual-studio-deployment-project/show-items.png" alt-text="显示节点":::
...
1. Visual Studio 编辑器提供了工具来帮助编辑资源管理器模板。 “JSON 大纲”窗口可让你轻松查看模板中定义的元素  。
   ...
   :::image type="content" source="./media/create-visual-studio-deployment-project/show-json-outline.png" alt-text="显示 JSON 大纲":::

1. 选择大纲中的一个元素以转到模板的那个部分。

   :::image type="content" source="./media/create-visual-studio-deployment-project/navigate-json.png" alt-text="导航 JSON":::

1. 可以通过选择“JSON 大纲”窗口顶部的“添加资源”  按钮，或右键单击“资源”  ，并选择“添加新资源”  ，来添加资源。

   :::image type="content" source="./media/create-visual-studio-deployment-project/add-resource.png" alt-text="屏幕截图显示了“JSON 大纲”窗口，其中突出显示了“添加新资源”选项。":::

1. 选择“存储帐户”  并为其命名。 提供一个名称，该名称不超过 11 个字符，并且只包含数字和小写字母。

   :::image type="content" source="./media/create-visual-studio-deployment-project/add-storage.png" alt-text="添加存储":::

1. 请注意，不仅会添加资源，而且还添加存储帐户类型的参数，以及存储帐户名称的变量。

   :::image type="content" source="./media/create-visual-studio-deployment-project/show-new-items.png" alt-text="显示大纲":::
...
1. Visual Studio 还提供 intellisense，帮助你了解在编辑模板时可用的属性。 例如，若要编辑应用服务计划的属性，请导航到 **HostingPlan** 资源，并为 **properties** 添加值。 请注意，Intellisense 显示可用的值，并提供该值的说明。
    ...
    :::image type="content" source="./media/create-visual-studio-deployment-project/show-intellisense.png" alt-text="显示 Intellisense":::
...
1. 在部署项目节点的快捷菜单中，选择“部署”   > “新建”  。
    ...
    :::image type="content" source="./media/create-visual-studio-deployment-project/deploy.png" alt-text="新建部署菜单项":::

1. 此时会显示“部署到资源组”对话框  。 在“资源组”  下拉框中，选择现有资源组或创建新资源组。 选择“部署”。 

    :::image type="content" source="./media/create-visual-studio-deployment-project/show-deployment.png" alt-text="部署到资源组对话框":::
...
1. 将显示所有已部署的资源。 请注意，存储帐户的名称并不完全是添加资源时指定的名称。 存储帐户必须是唯一的。 模板自动向所提供的名称添加一个字符串，以便创建唯一名称。
    ...
    :::image type="content" source="./media/create-visual-studio-deployment-project/show-deployed-resources.png" alt-text="显示资源":::
...
1. 将项目添加到 Visual Studio 解决方案。 右键单击解决方案，选择“添加”   > “新建项目”  。
    ...
    :::image type="content" source="./media/create-visual-studio-deployment-project/add-project.png" alt-text="添加项目":::

1. 添加“ASP.NET Core Web 应用程序”  。

    :::image type="content" source="./media/create-visual-studio-deployment-project/add-app.png" alt-text="添加 Web 应用":::

1. 为你的 web 应用命名，然后选择“创建”  。

    :::image type="content" source="./media/create-visual-studio-deployment-project/name-web-app.png" alt-text="为 web 应用命名":::

1. 选择“Web 应用程序”和“创建”   。

    :::image type="content" source="./media/create-visual-studio-deployment-project/select-project-type.png" alt-text="选择“Web 应用程序”":::

1. 在 Visual Studio 创建 Web 应用之后，可在解决方案中看到这两个项目。

    :::image type="content" source="./media/create-visual-studio-deployment-project/show-projects.png" alt-text="显示项目":::

1. 现在，需要确保资源组项目与此新项目之间建立链接。 返回到资源组项目 (ExampleAppDeploy)。 右键单击“引用”  ，选择“添加引用”  。

    :::image type="content" source="./media/create-visual-studio-deployment-project/add-new-reference.png" alt-text="屏幕截图显示了“ExampleAppDeploy”菜单，其中突出显示了“添加引用”选项。":::

1. 选择创建的 Web 应用项目。

   :::image type="content" source="./media/create-visual-studio-deployment-project/add-reference.png" alt-text="添加引用":::
   ...
   :::image type="content" source="./media/create-visual-studio-deployment-project/see-reference.png" alt-text="查看引用":::

1. 返回到你的模板 (WebSite.json)，向模板添加资源。

    :::image type="content" source="./media/create-visual-studio-deployment-project/add-resource-2.png" alt-text="添加资源":::

1. 这次选择“用于 Web 应用的 Web 部署”  。

    :::image type="content" source="./media/create-visual-studio-deployment-project/add-web-deploy.png" alt-text="添加 Web 部署":::
...
1. 若要重新部署，请选择“部署”  ，以及以前部署的资源组。
    ...
    :::image type="content" source="./media/create-visual-studio-deployment-project/redeploy.png" alt-text="重新部署项目":::

1. 为“生成工件存储帐户”选择部署此资源组时所用的存储帐户  。

   :::image type="content" source="./media/create-visual-studio-deployment-project/redeploy-web-app.png" alt-text="重新部署 web 部署":::

## <a name="view-web-app"></a>查看 Web 应用

1. 部署完毕后，请在门户中选择 Web 应用。 选择 URL 以浏览到此站点。

   :::image type="content" source="./media/create-visual-studio-deployment-project/browse-site.png" alt-text="浏览站点":::

1. 请注意已成功部署默认的 ASP.NET 应用程序。

   :::image type="content" source="./media/create-visual-studio-deployment-project/show-deployed-app.png" alt-text="显示已部署的应用":::
...
1. 部署完成后，请在门户中查看你的仪表板。 选择“仪表板”  并选择你部署的仪表板。
   ...
   :::image type="content" source="./media/create-visual-studio-deployment-project/view-custom-dashboards.png" alt-text="屏幕截图显示了“仪表板”页，其中突出显示了示例自定义仪表板。":::

1. 可看到自定义的仪表板。

   :::image type="content" source="./media/create-visual-studio-deployment-project/Ops-DemoSiteGroup-dashboard.png" alt-text="自定义仪表板":::
