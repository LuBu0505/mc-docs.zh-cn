...
ms.author: v-johya
ms.openlocfilehash: cc3b82cb90c3906566160a3aa7bdf0872c5ac26a
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102205018"
---
...
可使用 Azure CLI 中的 [az monitor action-rule create](/cli/ext/alertsmanagement/monitor/action-rule#ext-alertsmanagement-az-monitor-action-rule-create) 命令创建操作规则。  `az monitor action-rule` 参考只是众多[适用于 Azure Monitor 的 Azure CLI 参考](/cli/azure-cli-reference-for-monitor)中的一种。
...
查适关于 [az monitor action-rule create](/cli/ext/alertsmanagement/monitor/action-rule#ext-alertsmanagement-az-monitor-action-rule-create) 的 Azure CLI 参考内容，了解必需参数和可选参数。
...
可以使用 Azure CLI 中的 [az monitor action-rule](/cli/ext/alertsmanagement/monitor) 命令查看和管理操作规则。
