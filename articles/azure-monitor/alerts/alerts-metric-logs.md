...
ms.openlocfilehash: ee79185ade40ec80cc17a2fc5aecb53b39d8072d
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102205670"
---
...
3. **安装了受支持的 Log Analytics 解决方案**：Log Analytics 解决方案应已进行配置并可将数据发送到 Log Analytics 工作区 - 支持的解决方案为 [适用于 Windows 和 Linux 的性能计数器](./../agents/data-sources-performance-counters.md)、[更新管理](../../automation/update-management/overview.md)，以及 [事件数据](./../agents/data-sources-windows-events.md)。
