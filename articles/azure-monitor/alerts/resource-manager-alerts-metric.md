...
有关可用于指标警报规则的资源列表，请参阅 [Azure Monitor 中的指标警报支持的资源](../alerts/alerts-metric-near-real-time.md)。 有关警报规则的架构和属性的说明，请参阅[指标警报 - 创建或更新](https://docs.microsoft.com/rest/api/monitor/metricalerts/createorupdate)。
