...
ms.openlocfilehash: aba117b11e7cc7a01cb6494ad814238f8ebdac73
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102197201"
---
# <a name="use-the-voluntary-migration-tool-to-migrate-your-classic-alert-rules"></a>使用自愿性迁移工具迁移经典警报规则

[如以前所公告的那样](../platform/monitoring-classic-retirement.md)，Azure Monitor 中的经典警报已对公有云用户停用，但仍可有限制地用于那些尚不支持新警报的资源。 Azure 门户中为使用经典警报规则并想要自行触发迁移的客户提供了一个迁移工具。 本文介绍了如何使用该迁移工具。在进一步的公告发布之前，该工具也将用于剩余的警报。
...
1. 在 [Azure 门户](https://portal.azure.cn)中选择“监视”。
