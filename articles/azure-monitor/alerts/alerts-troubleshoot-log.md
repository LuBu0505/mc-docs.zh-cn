...
ms.topic: conceptual
ms.date: 03/22/2021
ms.openlocfilehash: 14a0ff7825f81fad037a5458bcc7e999f4f3a27d
ms.sourcegitcommit: 1a64114f25dd71acba843bd7f1cd00c4df737ba4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/26/2021
ms.locfileid: "105603102"
---
...
优化的查询是日志警报服务运行的内容。 你可以在 Log Analytics [门户](../logs/log-query-overview.md)或 [API](https://docs.microsoft.com/rest/api/loganalytics/) 中运行修改后的查询。
