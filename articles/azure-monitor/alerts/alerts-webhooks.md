...
ms.openlocfilehash: bf54c38cd3433e3c4932620006ee0badc749acc9
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102205000"
---
# <a name="call-a-webhook-with-a-classic-metric-alert-in-azure-monitor"></a>在 Azure Monitor 中对经典指标警报调用 Webhook

> [!WARNING]
> 本文介绍了如何使用旧式经典指标警报。 Azure Monitor 现在支持[较新的近实时指标警报和新的警报体验](../platform/alerts-overview.md)。 经典警报已对公有云用户[停用](../platform/monitoring-classic-retirement.md)，但仍可有限制地用于那些尚不支持新警报的资源。
>
