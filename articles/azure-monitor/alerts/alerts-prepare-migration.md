...
ms.openlocfilehash: d4064af6d87360a175dfaa7352d3ad904036291d
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102197205"
---
# <a name="prepare-your-logic-apps-and-runbooks-for-migration-of-classic-alert-rules"></a>准备逻辑应用和 Runbook 以迁移经典警报规则

> [!NOTE]
> [如以前所公告的那样](../platform/monitoring-classic-retirement.md)，Azure Monitor 中的经典警报已对公有云用户停用，但仍可有限制地用于那些尚不支持新警报的资源。 这些警报的停用日期已进一步延长。 即将公告新日期。
>
...
|Azure CLI     | [az monitor alert](/cli/monitor/alert)        | [az monitor metrics alert](/cli/monitor/metrics/alert)        |
