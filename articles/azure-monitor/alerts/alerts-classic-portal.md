...
ms.date: 02/20/2021
ms.openlocfilehash: e0e8e2e0460bc15b1e926612b0cb5348cc566586
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102205784"
---
# <a name="create-view-and-manage-classic-metric-alerts-using-azure-monitor"></a>使用 Azure Monitor 创建、查看和管理经典指标警报

> [!WARNING]
> 本文介绍了如何创建旧式经典指标警报。 Azure Monitor 现在支持[较新的近实时指标警报和新的警报体验](../platform/alerts-overview.md)。 经典警报已对公有云用户[停用](../platform/monitoring-classic-retirement.md)，但仍可有限制地用于那些尚不支持新警报的资源。
>
