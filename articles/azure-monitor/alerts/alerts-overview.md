...
ms.openlocfilehash: 4bc2ef2517a8eaf58955c64b18c7e5ed917b4eeb
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102205105"
---
...
可以使用[警报管理 REST API](https://docs.microsoft.com/rest/api/monitor/alertsmanagement/alerts) 获取有关特定警报的详细信息，包括其[警报上下文](../alerts/alerts-common-schema-definitions.md#alert-context)字段。
