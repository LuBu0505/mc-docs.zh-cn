...
ms.openlocfilehash: 1d4e0d8ee1aa6cf41829a9b0de16298715b7ce8a
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102205293"
---
...
> [!NOTE]
> 为自定义日志定义配置的 CustomLogRawJson 的格式可能很复杂。 使用 [Get-AzOperationalInsightsDataSource](https://docs.microsoft.com/powershell/module/az.operationalinsights/get-azoperationalinsightsdatasource) 检索现有自定义日志的配置。 Properties 属性是 CustomLogRawJson 参数的必需配置 。
