...
ms.topic: conceptual
ms.date: 03/25/2021
ms.openlocfilehash: 3dffc5911f8da3e614f4b519f7759e73a68e504c
ms.sourcegitcommit: 1a64114f25dd71acba843bd7f1cd00c4df737ba4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/26/2021
ms.locfileid: "105603113"
---
...
>  
>  
> 若要解决特定指标的这些限制，建议你使用[指标 REST API](https://docs.microsoft.com/rest/api/monitor/metrics/list) 手动提取它们并使用 [Azure Monitor 数据收集器 API](../logs/data-collector-api.md) 将其导入到 Azure Monitor 日志中。  
...
在 [Azure PowerShell](../powershell-samples.md) 中使用 [Set-AzDiagnosticSetting](https://docs.microsoft.com/powershell/module/az.monitor/set-azdiagnosticsetting) cmdlet 创建诊断设置。 有关参数说明，请参阅此 cmdlet 的文档。
...
在 [Azure CLI](/cli/monitor) 中使用 [az monitor diagnostic-settings create](/cli/monitor/diagnostic-settings#az-monitor-diagnostic-settings-create) 命令创建诊断设置。 有关参数说明，请参阅此命令的文档。
