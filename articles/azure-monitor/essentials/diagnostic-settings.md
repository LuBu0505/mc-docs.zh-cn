...
ms.date: 02/20/2021
ms.subservice: logs
ms.openlocfilehash: e7d70404e349fdc4093456675f63907b22123612
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102205229"
---
...
>  
>  
> 若要解决特定指标的这些限制，建议你使用[指标 REST API](https://docs.microsoft.com/rest/api/monitor/metrics/list) 手动提取它们并使用 [Azure Monitor 数据收集器 API](../platform/data-collector-api.md) 将其导入到 Azure Monitor 日志中。  
