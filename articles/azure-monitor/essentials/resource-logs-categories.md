...
ms.date: 02/20/2021
ms.author: v-johya
ms.openlocfilehash: 8e26689a316b58f1daac8d89dcc44fe0a663b61b
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102204857"
---
...
将某些类别的资源日志导出到这些位置需要额外费用。 下表列出了那些会产生导出费用的日志。 有关此定价的详细信息，请参阅 [Azure Monitor 定价页](https://www.azure.cn/pricing/details/monitor/)中的“平台日志”部分。
