...
ms.date: 01/27/2021
ms.author: v-johya
ms.openlocfilehash: ee01d61db6eecbaf0866c7305d790aa6a2cd4871
ms.sourcegitcommit: 5c4ed6b098726c9a6439cfa6fc61b32e062198d0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99061035"
---
...
- 在 [Log Analytics](../log-query/log-analytics-tutorial.md#write-a-query) CustomEvents 表的 customDimensions 中，查找内容字段下的单击数据。 如需查看其他指南，请参阅[示例应用](https://go.microsoft.com/fwlink/?linkid=2152871)。
- 构建一个[工作簿](../platform/workbooks-overview.md)，以创建单击数据的自定义可视化效果。
