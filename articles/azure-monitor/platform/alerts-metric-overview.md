...
ms.openlocfilehash: fc171a4b528d3ac1bf1458a8d55ef25813efe919
ms.sourcegitcommit: 5c4ed6b098726c9a6439cfa6fc61b32e062198d0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99060046"
---
...
- 指标：CPU 百分比
- 条件类型：静态
- 聚合类型（基于原始指标值运行的统计信息。 [支持的聚合类型](./metrics-aggregation-explained.md#aggregation-types)为最小值、最大值、平均值、总值、计数）：平均值
...
- [了解如何在 Azure 监视器指标资源管理器中创建警报](./metrics-charts.md#alert-rules)
