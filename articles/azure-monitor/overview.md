...
ms.author: v-johya
ms.date: 02/22/2021
ms.openlocfilehash: c7ef9e3e42e3eb7822af515e6609c7a3b2dc1323
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102197486"
---
...
- 通过[用于容器的 Azure Monitor](containers/container-insights-overview.md) 关联基础结构问题。
...
Azure Monitor 使用 [Kusto 查询语言](/data-explorer/kusto/query/)的某个版本，该查询语言适用于简单的日志查询，但也包括高级功能，例如聚合、联接、智能分析。 可以通过[多个课程](logs/get-started-queries.md)快速了解此查询语言。  特定指南提供给已熟悉 [SQL](log-query/sql-cheatsheet.md) 和 [Splunk](log-query/splunk-cheatsheet.md) 的用户。
