...
description: 了解如何在 Azure Databricks 中使用 SQL 语言的 GROUP BY 语法。
ms.openlocfilehash: b3662f6b9a792e6bd9e049ea0e0e2635f3f491a9
ms.sourcegitcommit: 5c4ed6b098726c9a6439cfa6fc61b32e062198d0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99060904"
---
# <a name="group-by-clause"></a>GROUP BY 子句

基于一组指定的分组表达式对行进行分组，并基于一个或多个指定的聚合函数对行组计算聚合。 Spark 还支持高级聚合，以通过 ``GROUPING SETS``、``CUBE`` 和 ``ROLLUP`` 子句对同一输入记录集进行多个聚合。
