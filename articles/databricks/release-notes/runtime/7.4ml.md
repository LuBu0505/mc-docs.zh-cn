...
author: mssaperla
ms.date: 12/01/2020
title: 用于机器学习的 Databricks Runtime 7.4 - Azure Databricks
description: 关于由 Apache Spark 提供支持的适用于机器学习的 Databricks Runtime 7.4 的发行说明。
ms.openlocfilehash: a79e7809e111b8d409ba46ad8cf0c60b69f1231b
ms.sourcegitcommit: 5c4ed6b098726c9a6439cfa6fc61b32e062198d0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99060805"
---
# <a name="databricks-runtime-74-for-machine-learning"></a>用于机器学习的 Databricks Runtime 7.4

Databricks 于 2020 年 11 月发布了此映像。

用于机器学习的 Databricks Runtime 7.4 基于 [Databricks Runtime 7.4](7.4.md)，为机器学习和数据科学提供了随时可用的环境。 Databricks Runtime ML 包含许多常用的机器学习库，包括 TensorFlow、PyTorch 和 XGBoost。 它还支持使用 Horovod 进行分布式深度学习训练。
...
Databricks Runtime 7.4 ML 基于 Databricks Runtime 7.4 构建。 若要了解 Databricks Runtime 7.4 中的新增功能，包括 Apache Spark MLlib 和 SparkR，请参阅 [Databricks Runtime 7.4](7.4.md) 发行说明。

### <a name="major-changes-to-databricks-runtime-ml-scala-environment"></a>Databricks Runtime ML Scala 环境的主要更改

XGBoost 升级到了 1.2.0。 该版本允许 XGBoost 在 Spark 群集上使用 GPU 来提高训练速度。 还有其他一些更改，包括一些中断性变更。 有关详细信息，请参阅 [XGBoost 1.2.0 发行说明](https://github.com/dmlc/xgboost/releases/tag/v1.2.0)。

具体来说，在 CPU 群集上，``xgboost4j_2.12`` 和 ``xgboost4j-spark_2.12`` 从 1.0.0 升级到了 1.2.0。 在 GPU 群集上，这些包被删除，改为安装 ``xgboost4j-gpu_2.12`` 和 ``xgboost4j-spark-gpu_2.12`` 的版本 1.2.0。

GraphFrames 从 0.8.0-db2-spark3.0 升级到 0.8.1-db1-spark3.0。

### <a name="major-changes-to-databricks-runtime-ml-python-environment"></a>Databricks Runtime ML Python 环境的主要更改

请参阅 [Databricks Runtime 7.4](7.4.md) 中 Databricks Runtime Python 环境的主要更改。
...
* Databricks Runtime 7.4 中修复了导致 PyTorch 失败的某些 pickling 问题。 有关详细信息，请参阅 [Databricks Runtime 7.4](7.4.md#other-fixes) 发行说明。
* Horovod 0.20.3 支持在 Azure Databricks 上使用 ``horovod.spark`` 包。 请参阅 [horovod.spark：使用 Horovod 进行分布式深度学习](../../applications/machine-learning/train-model/distributed-training/horovod-spark.md)。

## <a name="system-environment"></a>系统环境

Databricks Runtime 7.4 ML 中的系统环境在以下方面不同于 Databricks Runtime 7.4：

* Open MPI 已从 4.0.4 升级到 4.0.5
...
以下部分列出了 Databricks Runtime 7.4 ML 中包含的库，这些库不同于 Databricks Runtime 7.4 中包含的库。
...
Databricks Runtime 7.4 ML 包含以下顶层[库](../../runtime/mlruntime.md#mllibraries)：
...
Databricks Runtime 7.4 ML 使用 Conda 进行 Python 包管理，并且包含许多常用的 ML 包。

除了在以下部分的 Conda 环境中指定的包外，Databricks Runtime 7.4 ML 还安装以下包：
...
R 库与 [Databricks Runtime 7.4 中的 R 库](7.4.md#rlibraries)完全相同。

### <a name="java-and-scala-libraries-scala-212-cluster"></a>Java 库和 Scala 库（Scala 2.12 群集）

除了 Databricks Runtime 7.4 中的 Java 库和 Scala 库之外，Databricks Runtime 7.4 ML 还包含以下 JAR：
