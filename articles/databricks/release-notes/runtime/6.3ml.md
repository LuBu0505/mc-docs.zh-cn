...
author: mssaperla
ms.date: 12/01/2020
title: 用于机器学习的 Databricks Runtime 6.3（不受支持）- Azure Databricks
description: 关于由 Apache Spark 提供支持的用于机器学习的 Databricks Runtime 6.3 的发行说明。
ms.openlocfilehash: 91983b569be30ee92301883ea068948d6b5c4c6c
ms.sourcegitcommit: 5c4ed6b098726c9a6439cfa6fc61b32e062198d0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99058676"
---
# <a name="databricks-runtime-63-for-machine-learning-unsupported"></a>用于机器学习的 Databricks Runtime 6.3（不受支持）

Databricks 于 2020 年 1 月发布了此映像。

用于机器学习的 Databricks Runtime 6.3 基于 [Databricks Runtime 6.3（不受支持）](6.3.md)，为机器学习和数据科学提供了随时可用的环境。
