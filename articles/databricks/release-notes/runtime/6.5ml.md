...
author: mssaperla
ms.date: 12/01/2020
title: 用于机器学习的 Databricks Runtime 6.5（不受支持）- Azure Databricks
description: 关于由 Apache Spark 提供支持的用于机器学习的 Databricks Runtime 6.5 的发行说明。
ms.openlocfilehash: db2cf5d7ee2bdad17534d43d66c27fe0ac33ce9f
ms.sourcegitcommit: 5c4ed6b098726c9a6439cfa6fc61b32e062198d0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99058672"
---
# <a name="databricks-runtime-65-for-machine-learning-unsupported"></a>用于机器学习的 Databricks Runtime 6.5（不受支持）

Databricks 于 2020 年 4 月发布了此映像。

用于机器学习的 Databricks Runtime 6.5 基于 [Databricks Runtime 6.5（不受支持）](6.5.md)，为机器学习和数据科学提供了随时可用的环境。
...
Databricks Runtime 6.5 ML 基于 Databricks Runtime 6.5 构建。 若要了解 Databricks Runtime 6.5 中的新增功能，请参阅 [Databricks Runtime 6.5（不受支持）](6.5.md)发行说明。
