...
description: 了解如何在 Azure Databricks 中以 SQL Analytics SQL 语言使用开窗函数。
ms.openlocfilehash: 8ff6ed36674f746e5588626042e1d3dd9570f130
ms.sourcegitcommit: bb7497d5a11e8fb506907221ff65a18e6c523372
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/22/2021
ms.locfileid: "98692297"
---
...
* **window_function**
  ...
  * 聚合函数
    ...
    **语法：** ``MAX | MIN | COUNT | SUM | AVG | ...``
    ...
    有关聚合函数的完整列表，请参阅[内置聚合函数](sql-ref-functions-builtin.md#aggregate-functions)文档。
