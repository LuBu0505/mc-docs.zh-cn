...
* [当传入查询的记录类型不同于与终结点寻址类型关联的记录类型时，会出现什么情况？](./traffic-manager-faqs.md#what-happens-when-an-incoming-querys-record-type-is-different-from-the-record-type-associated-with-the-addressing-type-of-the-endpoints)
