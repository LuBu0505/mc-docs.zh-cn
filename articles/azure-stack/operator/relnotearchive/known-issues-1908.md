...
description: 了解 Azure Stack 1908 发行版中的已知问题。
...
ROBOTS: NOINDEX
ms.openlocfilehash: 4ec48b7aea36ff704daf789c07bc5b4fdb683be4
ms.sourcegitcommit: 3f32b8672146cb08fdd94bf6af015cb08c80c390
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/03/2021
ms.locfileid: "101751776"
---
...
- 适用于：此问题适用于所有支持的版本。
- 原因：尝试安装 Azure Stack 更新时，更新状态可能会失败并更改为“PreparationFailed”。 这是因为更新资源提供程序 (URP) 无法正确将文件从存储容器传输到内部基础结构共享进行处理。
...
- 适用于：此问题适用于所有支持的版本。
- 原因：在管理员门户中，用户订阅的“锁定”边栏选项卡有两个“订阅”按钮。
- 发生次数：通用
...
- 适用于：此问题适用于所有支持的版本。
- 原因：在用户门户中，删除“本地网络网关”会显示以下错误消息：“无法删除具有活动连接的本地网络网关”，即使没有活动连接也是如此。
