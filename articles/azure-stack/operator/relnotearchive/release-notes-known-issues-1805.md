...
ms.reviewer: justini
ROBOTS: NOINDEX
ms.openlocfilehash: 8e82f1b2ee3dcd24517bf14911d5aa3238ca05b0
ms.sourcegitcommit: 3f32b8672146cb08fdd94bf6af015cb08c80c390
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/03/2021
ms.locfileid: "101751773"
---
...
> [!TIP]  
> 根据客户的反馈，Azure Stack 使用的版本架构已做出更新。  从 1805 更新开始，新架构更能代表当前的云版本。  
> 
...
- 在安装 1805 更新期间，可能会出现标题如下的警报：“错误 - 缺少 FaultType UserAccounts.New 的模板”。  可以放心地忽略这些警报。 更新到 1805 之后，这些警报将自动关闭。   
...
<!-- TBD - IS ASDK --> 
- 无法在管理员或用户门户中创建用户定义的路由。 解决方法是使用 [Azure PowerShell](/virtual-network/tutorial-create-route-table-powershell)。
