...
description: 了解 Azure Stack 1906 发行版中的已知问题。
...
ROBOTS: NOINDEX
ms.openlocfilehash: 5eb6cadb4f52f198f09ccd84ff4e47d782bea75a
ms.sourcegitcommit: 3f32b8672146cb08fdd94bf6af015cb08c80c390
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/03/2021
ms.locfileid: "101751854"
---
...
- 适用于：此问题适用于所有支持的版本。
- 原因：尝试安装 1906 Azure Stack 更新时，更新状态可能会失败并更改为“PreparationFailed”。 这是因为更新资源提供程序 (URP) 无法正确将文件从存储容器传输到内部基础结构共享进行处理。 
