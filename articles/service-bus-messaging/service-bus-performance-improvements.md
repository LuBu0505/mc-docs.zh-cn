...
ms.openlocfilehash: 6751374fb3b700e289c361c1078e3bf8fb537f9d
ms.sourcegitcommit: 136164cd330eb9323fe21fd1856d5671b2f001de
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102196555"
---
...
与服务交互的服务总线对象（例如 [ServiceBusClient](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebusclient)、 [ServiceBusSender](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebussender)、[ServiceBusReceiver](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebusreceiver) 和 [ServiceBusProcessor](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebusprocessor)）应作为单一实例为依赖项注入而注册（或实例化一次并共享）。 可以通过 [ServiceBusClientBuilderExtensions](https://github.com/Azure/azure-sdk-for-net/blob/master/sdk/servicebus/Azure.Messaging.ServiceBus/src/Compatibility/ServiceBusClientBuilderExtensions.cs) 为依赖项注入而注册 ServiceBusClient。 

建议你在发送或接收每条消息后不要关闭或释放这些对象。 关闭或释放特定于实体的对象 (ServiceBusSender/Receiver/Processor) 会导致指向服务总线服务的链接断开。 释放 ServiceBusClient 会导致与服务总线服务的连接断开。 建立连接是一项成本高昂的操作，你可以通过重复使用同一 ServiceBusClient 并从同一 ServiceBusClient 实例创建必要的实体特定对象来避免这一操作。 这些客户端对象可安全地用于并发异步操作及从多个线程安全地使用。
...
<!--CORRECT ON https://docs.microsoft.com/dotnet/api/-->
...
- [ServiceBusReceiver.PrefetchCount](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebusreceiver.prefetchcount)
- [ServiceBusProcessor.PrefetchCount](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebusprocessor.prefetchcount)

可以在 [ServiceBusReceiverOptions](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebusreceiveroptions) 或 [ServiceBusProcessorOptions](https://docs.microsoft.com/dotnet/api/azure.messaging.servicebus.servicebusprocessoroptions) 中设置这些属性的值。
