...
ms.openlocfilehash: 1869c54bf97eb7fadad44f6eea00858f5e1c2473
ms.sourcegitcommit: 8b3a588ef0949efc5b0cfb5285c8191ce5b05651
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2021
ms.locfileid: "104767543"
---
...
1. 将以下代码添加到 `InitializeDialogServiceConnector` 的方法主体。
   ...
   const string region = "YourServiceRegion"; // The subscription service region. Note: only 'chinanorth2' is currently supported
