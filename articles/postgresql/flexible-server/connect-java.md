...
ms.date: 02/08/2021
ms.openlocfilehash: 555ac95527af54e9f43258b2b1fbd74bdedf6271
ms.sourcegitcommit: 20bc732a6d267b44aafd953516fb2f5edb619454
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/03/2021
ms.locfileid: "99504442"
---
...
- `<YOUR_AZURE_REGION>`：将使用的 Azure 区域。 默认情况下可以使用 `chinaeast2`，但我们建议你配置一个离居住位置更近的区域。 可输入 `az account list-locations`，获取可用区域的完整列表。
