...
ms.date: 02/01/2021
ms.openlocfilehash: 4d53263e89320185fe2d24b504f3f7aa05b4855e
ms.sourcegitcommit: 5c4ed6b098726c9a6439cfa6fc61b32e062198d0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2021
ms.locfileid: "99059664"
---
...
需要放在防火墙允许列表中的一个必需域和端口用于与 Azure 中继进行通信。 自承载集成运行时使用它进行交互式创作，例如测试连接、浏览文件夹列表和表列表、获取架构，以及预览数据。 如果你不想允许 .servicebus.windows.net，希望获得更具体的 URL，则可从 ADF 门户获取你的自承载集成运行时所需的所有 FQDN。
