...
description: 使用 Azure CLI 在具有分层命名空间的存储帐户中管理访问控制列表 (ACL)。
services: storage
author: WenJason
ms.service: storage
...
ms.openlocfilehash: 81991085439748a34cdd65a6665d7aaadeddec94
ms.sourcegitcommit: 8b3a588ef0949efc5b0cfb5285c8191ce5b05651
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2021
ms.locfileid: "104766877"
---
...
本文介绍如何使用 [Azure 命令行接口 (CLI)](/cli/) 来获取、设置和更新目录和文件的访问控制列表。

ACL 继承已可用于在父目录下创建的新子项。 但是你也可以为父目录的现有子项以递归方式添加、更新和删除 ACL，而不必为每个子项单独进行这些更改。

[参考](/cli/storage/fs/access) | [示例](https://github.com/Azure/azure-cli/blob/dev/src/azure-cli/azure/cli/command_modules/storage/docs/ADLS%20Gen2.md) | [提供反馈](https://github.com/Azure/azure-cli-extensions/issues)
...
> [!NOTE]
> 若要更新特定组或用户的 ACL，请使用其相应的对象 ID。 例如 `group:xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx` 或 `user:xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx`。
