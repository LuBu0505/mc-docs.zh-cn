...
ms.openlocfilehash: e5c99b7f552f823eca8ac9cd0c60b6a38baa11ad
ms.sourcegitcommit: ef5fa52ac5e0e3881f72bd8b56fc73e49444ccc2
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/04/2021
ms.locfileid: "99540753"
---
...
本文介绍如何在 Azure Active Directory (Azure AD) 中创建组织范围的角色分配。 在组织范围分配角色会跨 Azure AD 组织授予访问权限。 若要创建范围为一个 Azure AD 资源的角色分配，请参阅[如何创建自定义角色并在资源范围内进行分配](custom-create.md)。 本文使用 [Azure Active Directory PowerShell 版本 2](https://docs.microsoft.com/powershell/module/azuread/#directory_roles) 模块。
...
若要将该角色分配给服务主体而不是用户，请使用 [Get-AzureADMSServicePrincipal](https://docs.microsoft.com/powershell/module/azuread/get-azureadserviceprincipal) cmdlet。
