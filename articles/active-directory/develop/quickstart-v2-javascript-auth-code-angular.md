...
description: 本快速入门介绍 JavaScript Angular 单页应用程序 (SPA) 如何通过授权代码流使用工作帐户和学校帐户将用户登录，并调用 Microsoft Graph。
...
ms.openlocfilehash: 1209515612d00f012687036ec77ca634950d07f5
ms.sourcegitcommit: 3f32b8672146cb08fdd94bf6af015cb08c80c390
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/03/2021
ms.locfileid: "101697883"
---
...
>
> app.module.ts 中的 `authority` 值应类似于以下内容：
>
> ```javascript
...
> - 将字符串 `Enter_the_Graph_Endpoint_Herev1.0/me` 替换为 `https://microsoftgraph.chinacloudapi.cn/v1.0/me`
> - `Enter_the_Graph_Endpoint_Herev1.0/me` 是将针对其进行 API 调用的终结点。 对于主要或全局 Microsoft Graph API 服务，请输入 `https://microsoftgraph.chinacloudapi.cn/`（包括末尾的正斜杠）。 有关详细信息，请参阅[本文档](https://docs.microsoft.com/graph/deployments)。
>
>
> ```javascript
