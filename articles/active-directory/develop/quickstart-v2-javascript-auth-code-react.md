...
description: 本快速入门介绍 JavaScript React 单页应用程序 (SPA) 如何通过授权代码流使用工作帐户和学校帐户将用户登录，并调用 Microsoft Graph。
...
ms.openlocfilehash: ff5ab5bb47f36d37fcc0b4785688415a9a55609b
ms.sourcegitcommit: 8b3a588ef0949efc5b0cfb5285c8191ce5b05651
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2021
ms.locfileid: "104765508"
---
...
>
> authConfig.js 中的 `authority` 值应类似于以下内容：
>
> ```javascript
