...
ms.date: 03/01/2021
ms.author: v-jay
ms.openlocfilehash: c1e993cf2aa2361c9ac31347936051516ff5a10b
ms.sourcegitcommit: 3f32b8672146cb08fdd94bf6af015cb08c80c390
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/03/2021
ms.locfileid: "101696866"
---
...
A. 如果使用 5 个磁盘，并且每个磁盘具有 8 TB 容量（7 TB 可用容量），则最大可用容量为 35 TB。 因此，可在一个实例中传输 35 TB 数据。 若要传输更多数据，需订购更多的磁盘。
