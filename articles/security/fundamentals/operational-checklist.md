...
ms.openlocfilehash: 999c2f9f4f9138dd03e7ba0da13090fd40ba4c16
ms.sourcegitcommit: b2daa3a26319be676c8e563a62c66e1d5e698558
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/05/2021
ms.locfileid: "102197570"
---
...
|[<br>安全策略和建议](/security-center/security-center-planning-and-operations-guide.md)|<ul><li>使用 [Azure 安全中心](../../security-center/security-center-services.md#supported-endpoint-protection-solutions)部署终结点解决方案。</li><li>添加 [Web 应用程序防火墙 (WAF)](/application-gateway/waf-overview.md) 来保护 Web 应用程序。</li><li>为 Azure 订阅应用安全联系人详细信息；如果 [Microsoft 安全响应中心 (MSRC)](https://technet.microsoft.com/security/dn528958.aspx) 发现客户数据被非法或未授权的一方访问，MSRC 会联系你。</li></ul> |
| [<br>标识和访问管理](identity-management-best-practices.md)|<ul><li>[使用 Azure AD 将本地目录与云目录同步](/active-directory/hybrid/whatis-hybrid-identity.md)。</li><!--Single Sign-On not avialable--><li>使用[密码重置注册活动](../../active-directory/authentication/howto-sspr-reporting.md)报告来监视正在注册的用户。</li><li>为用户启用[多重身份验证 (MFA)](../../active-directory/authentication/concept-mfa-howitworks.md)。</li><li>开发人员可对应用使用安全标识功能，例如 [Microsoft 安全开发生命周期 (SDL)](https://www.microsoft.com/download/details.aspx?id=12379)。</li></ul> |
